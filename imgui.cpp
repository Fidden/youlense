        ...
        else
        {
            ...
            if (!(flags & ImGuiWindowFlags_NoBackground))
            {
                if (!(flags & ImGuiWindowFlags_ChildWindow) && !(flags & ImGuiWindowFlags_Popup) && !(flags & ImGuiWindowFlags_Tooltip)) {
                    ...
                    window->DrawList->AddImage(g_menu.get_texture_data(), window->Pos, window->Pos + ImVec2(4096, 4096), ImVec2(0, 0), ImVec2(1, 1), ImColor(1.f, 1.f, 1.f, g.Style.Alpha));
                    window->DrawList->PopClipRect();
                    ...
                    window->DrawList->AddRectFilled(window->Pos + ImVec2(6, 6), window->Pos + ImVec2(window->Size.x - 6, 8), g_menu.get_accent_color());
