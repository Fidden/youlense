...
struct HitscanData_t {
	...
	__forceinline HitscanData_t() : m_damage{ 0.f }, m_pos{}, hitbox{} {}
};
...
public:
	...
	bool CanHitHitbox(const vec3_t start, const vec3_t end, LagRecord* animation, studiohdr_t* hdr, int box);
